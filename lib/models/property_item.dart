...
final List<PropertyItem> sampleProperties = [
  ...
  const PropertyItem(
    id: 'prop_5',
    title: 'قطعة أرض مباني متميزة (175 م²)',
    location: 'كورنيش النيل - جرجا، سوهاج',
    price: 1450000.0,
    priceUnit: 'ج.م كاش',
    type: 'أرض مباني للبيع',
    areaSqM: 175,
    bedrooms: 0,
    bathrooms: 0,
    livingRooms: 0,
    ...
    reviewsCount: 95,
    description:
        'قطعة أرض مباني سكنية متميزة بحري صريح على الشارع الرئيسي بكورنيش النيل بجرجا، مسجلة وشاملة كافة المرافق (مياه، كهرباء، غاز، تليفون).',
    ...
    isFeatured: true,
    agentName: 'المهندس أحمد حسني',
    agentRole: 'مستشار وتقسيم أراضي',
  ),
  const PropertyItem(
    id: 'prop_6',
    title: 'أرض استثمارية/زراعية (5 قراريط)',
    location: 'طريق جرجا السريع - سوهاج',
    price: 650000.0,
    priceUnit: 'ج.م كاش',
    type: 'أرض زراعية للبيع',
    areaSqM: 875,
    bedrooms: 0,
    bathrooms: 0,
    livingRooms: 0,
    ...
    reviewsCount: 42,
    description:
        'أرض استثمارية زراعية بموقع حيوي على طريق جرجا السريع، تقع ضمن حيز الامتداد العمراني مع ري بحاري وممر وسهل الوصول.',
    contactPhone: '01299887766',
    contactWhatsApp: '201299887766',
    imagePath: 'assets/images/cat_realestate.png',
    galleryPhotos: [
      'assets/images/cat_realestate.png',
      'assets/images/realestate_apartment.png',
    ...
    isFeatured: true,
    agentName: 'د. محمود صابر',
    agentRole: 'خبير استثمار أراضي ومشاريع',
  ),
];
