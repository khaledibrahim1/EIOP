    ...
    switch (categoryId) {
      ...
      case 'jobs':
        return [
          {
            'id': 'j1',
            'title': 'مطور ومصمم تطبيقات Flutter وشاشات',
            'price': 6500.0,
            'oldPrice': 7500.0,
            'category': 'وظائف كاملة',
            'badge': '18 متقدم 💼 • راتب 6,500 ج.م',
            'isAvailable': true,
            'imagePath': 'assets/images/job_opportunity.png',
          },
          {
            'id': 'j2',
            'title': 'محاسب مالي وإدارة مبيعات بشركة تجارية',
            'price': 5000.0,
            'oldPrice': null,
            'category': 'وظائف كاملة',
            'badge': '12 متقدم 💼 • دوام كامل',
            'isAvailable': true,
            'imagePath': 'assets/images/cat_jobs.png',
          },
          {
            'id': 'j3',
            'title': 'مندوب توصيل ومبيعات ميدانية جرجا',
            'price': 4500.0,
            'oldPrice': 5000.0,
            'category': 'دوام جزئي',
            'badge': 'عاجل ⚡ • ورديات',
        ...
        return [
          {
            ...
            'address': 'جرجا - شارع الجمهورية',
            'items': 'طلب تقديم: مطور ومصمم تطبيقات Flutter (مرفق CV 📄)',
            'position': 'مطور ومصمم تطبيقات Flutter',
            'experience': '4 سنوات خبيرة في Flutter & Dart & Firebase',
            'total': 6500.0,
            'time': 'منذ 5 دقائق',
            'status': 'الجديدة',
            'atsScore': 96,
            'skills': ['Flutter', 'Dart', 'State Management', 'Clean Code', 'REST API'],
            'cvFileName': 'Khaled_Ibrahim_Flutter_Dev_CV.pdf',
            'cvSize': '2.4 MB',
            'rating': 5.0,
            'review': 'مرشح ممتاز يمتلك خبرة قوية في بناء الواجهات التفاعلية وتصميم تطبيقات الهاتف بأداء عالي!',
          },
          {
            'id': '#JOB-098',
            ...
            'address': 'جرجا - شارع البحر الرئيسي',
            'items': 'طلب تقديم: محاسبة وإدارة مالية (مرفق CV 📄)',
            'position': 'محاسبة مالية ومسؤولة مبيعات',
            'experience': '3 سنوات في الإدارة المالية ومراجعة الحسابات',
            'total': 5000.0,
            'time': 'منذ ساعتين',
            'status': 'المقبولين ✅',
            'atsScore': 92,
            'skills': ['Excel Advanced', 'الحسابات العامة', 'إدارة المخزون', 'التحليل المالي'],
            'cvFileName': 'Sara_Mohamed_Accountant_CV.pdf',
            'cvSize': '1.8 MB',
            'rating': 4.9,
            'review': 'مقبولة نهائياً وتم تحديد موعد المقابلة الشخصية يوم الأحد القادم.',
          },
          {
            'id': '#JOB-085',
            'customerName': 'محمود علي حسان',
            'phone': '01234567890',
            'email': 'mahmoud.ali@email.com',
            'address': 'جرجا - شارع المحطة',
            'items': 'طلب تقديم: مهندس شبكات ودعم فني (مرفق CV 📄)',
            'position': 'مهندس شبكات وسيرفرات IT',
            'experience': '5 سنوات خبرة شبكات وصيانة خوادم',
            'total': 7000.0,
            'time': 'منذ 3 ساعات',
            'status': 'المقبولين ✅',
            'atsScore': 94,
            'skills': ['Cisco CCNA', 'Linux Administration', 'Network Security', 'VoIP'],
            'cvFileName': 'Mahmoud_Ali_IT_Engineer.pdf',
            'cvSize': '3.1 MB',
            'rating': 5.0,
            'review': 'مقبول بنسبة توافق عالية مع المتطلبات المباشرة لقسم تقنية المعلومات.',
          },
          {
            'id': '#JOB-074',
            'customerName': 'أحمد حسن فؤاد',
            'phone': '01011223344',
            'email': 'ahmed.hassan@email.com',
            'address': 'جرجا - ميدان النهضة',
            'items': 'طلب تقديم: مندوب تسويق ومبيعات ميداني (مرفق CV 📄)',
            'position': 'مسؤول مبيعات وتسويق ميداني',
            'experience': 'سنة واحدة في المبيعات',
            'total': 4500.0,
            'time': 'أمس',
            'status': 'قيد الفرز والتدقيق',
            'atsScore': 78,
            'skills': ['التواصل الفعال', 'إقناع العملاء', 'قيادة السيارات'],
            'cvFileName': 'Ahmed_Hassan_Sales_CV.pdf',
            'cvSize': '1.2 MB',
            'rating': 4.2,
            'review': 'جارِ فحص وتدقيق الخبرات السابقة والتواصل مع الجهات المرجعية.',
          },
          {
            'id': '#JOB-061',
            'customerName': 'مصطفى طارق محمود',
            'phone': '01555667788',
            'email': 'mustafa.tarek@email.com',
            'address': 'جرجا - شارع المطار',
            'items': 'طلب تقديم: مصمم جرافيك وواجهات UI/UX (مرفق CV 📄)',
            'position': 'مصمم UI/UX وواجهات مستخدم',
            'experience': '3 سنوات في تصميم Figma & Adobe XD',
            'total': 6000.0,
            'time': 'أمس',
            'status': 'المقبولين ✅',
            'atsScore': 98,
            'skills': ['Figma', 'UI/UX Design', 'Design Systems', 'Micro-interactions', 'Prototyping'],
            'cvFileName': 'Mustafa_Tarek_UIUX_Portfolio.pdf',
            'cvSize': '4.5 MB',
            'rating': 5.0,
            'review': 'مرشح متصدر القائمة 🥇 أعلى نسبة توافق ATS وسيرة ذاتية احترافية!',
          },
          {
            'id': '#JOB-049',
            'customerName': 'هاني عبدالكريم',
            'phone': '01299887766',
            'email': 'hani.kareem@email.com',
            'address': 'جرجا - بحري النفق',
            'items': 'طلب تقديم: فني صيانة وأجهزة إلكترونية (مرفق CV 📄)',
            'position': 'فني صيانة إلكترونيات',
            'experience': 'بدون خبرة سابقة في المجال المطلوب',
            'total': 3500.0,
            'time': 'منذ يومين',
            'status': 'المرفوضين ❌',
            'atsScore': 42,
            'skills': ['مبادئ الكهرباء العامة'],
            'cvFileName': 'Hani_Kareem_CV.pdf',
            'cvSize': '900 KB',
            'rating': 2.5,
            'review': 'تم الرفض لعدم استيفاء الحد الأدنى من متطلبات الخبرة التقنية المطلوبة.',
          },
          {
            'id': '#JOB-033',
            'customerName': 'ريم طاهر مصطفى',
            'phone': '01033445566',
            'email': 'reem.taher@email.com',
            'address': 'جرجا - شارع البوسطة القديمة',
            'items': 'طلب تقديم: كاتب محتوى ومسؤول وسائل التواصل (مرفق CV 📄)',
            'position': 'مسؤولة سوشيال ميديا وصناعة محتوى',
            'experience': '2 سنة في إدارات الصفحات وإنشاء المحتوى',
            'total': 4800.0,
            'time': 'منذ 3 أيام',
            'status': 'المرفوضين ❌',
            'atsScore': 55,
            'skills': ['كتابة المحتوى', 'فيس بوك'],
            'cvFileName': 'Reem_Taher_Content_CV.pdf',
            'cvSize': '1.1 MB',
            'rating': 3.0,
            'review': 'تم الإكتفاء بالعدد المطلوب في هذا التخصص.',
          },
        ];
